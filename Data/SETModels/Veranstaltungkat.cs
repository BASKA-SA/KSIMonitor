...
namespace KSIMonitor.Data.SETModels {
    [Keyless]
    [Table("veranstaltungkat")]
    public partial class Veranstaltungkat {
        [Column("vernr")]
